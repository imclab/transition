class MappingsController < ApplicationController
  ...
  def new_multiple_confirmation
    redirect_to site_return_url, notice: bulk_add.params_invalid_notice and return if bulk_add.params_invalid?
  end
  ...
  def edit_multiple
    redirect_to site_return_url, notice: bulk_edit.params_invalid_notice and return if bulk_edit.params_invalid?
...
private
  def bulk_add
    @bulk_add ||= View::Mappings::BulkAdder.new(@site, params, site_return_url)
  end

  def bulk_edit
    @bulk_edit ||= View::Mappings::BulkEditor.new(@site, params, site_return_url)
  end
